...
export default function CarouselSlide({
  ...
  return (
    <article
      className="relative shrink-0 overflow-hidden rounded-2xl shadow-[0_24px_48px_-12px_rgba(0,0,0,0.65)] ring-1 ring-white/10"
    ...
    >
      ...
      {/* Side vignette for dramatic contrast */}
      <div
        className="pointer-events-none absolute inset-0"
        style={{
          background:
